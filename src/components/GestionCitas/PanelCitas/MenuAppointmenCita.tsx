...
const MenuAppointmenCita = ({ data }: Props) => {
  ...
  const citaListaEspera = useUpdateStatusCitaListaEspera(setOpenMenuAppointment)
  ...
  const isLoading =
    citaConfirmada.isPending ||
    citaListaEspera.isPending ||
    citaCancelada.isPending ||
    citaDelete.isPending
