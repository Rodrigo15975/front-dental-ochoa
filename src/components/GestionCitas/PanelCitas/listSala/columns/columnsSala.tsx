...
const ColumnsListSala = () => {
  const { mutate } = useUpdateStatusCitaAtendida();
  ...
  const acciones = (data: GetAllCitas) => {
    return (
      <div>
        <Button
          type="button"
          className="bg-bg_three/80 w-full hover:bg-bg_three/30 transition h-[2.5rem] rounded-md shadow-md font-robotoSlab_600"
