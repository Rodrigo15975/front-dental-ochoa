...
import { PacienteMayor } from "./inputsPacienteMayor";

const ButtonInputDniPacienteMayor = () => {
  const { values, setFieldValue } = useFormikContext<PacienteMayor>();
...
export default ButtonInputDniPacienteMayor;
