  ...
  return (
    <div className="flex flex-col gap-8 mb-[2rem]">
      ...
      <Button
        label="Login"
        type="submit"
        className="flex mt-[1.5rem] border text-default shadow-md hover:shadow-none transition font-robotoSlab_500 text-xl items-center justify-center gap-2 bg-bg_six rounded-full w-full h-[3rem]"
      >
